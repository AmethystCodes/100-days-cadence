...
pub contract Tamagotchi {
    ...
    pub resource Collection: INFT {
        ...
        // is only available in the scope of the
        // entire account where it's defined
        access(account) ownedNFTs: @{UInt64: NFT}
    ...
    init() {
        ...
        self.MinterStoragePath = /storage/TamagotchiMinter
